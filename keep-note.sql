...
CREATE TABLE Note(note_id INT(3) primary key, note_title VARCHAR(20) not null, note_content VARCHAR(50) , note_status VARCHAR(20) , note_creation_date DATETIME not null);
