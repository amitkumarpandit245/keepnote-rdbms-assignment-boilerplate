CREATE TABLE User(user_id INT(3), user_name VARCHAR(20), user_added_date DATE, user_password VARCHAR(20), user_mobile BIGINT(10));
CREATE TABLE Note(note_id INT(3), note_title VARCHAR(20), note_content VARCHAR(50), note_status VARCHAR(20), note_creation_date DATE);
CREATE TABLE Category(category_id INT(2), category_name VARCHAR(20), category_descr VARCHAR(20), category_creation_date DATE, category_creator VARCHAR(20));
CREATE TABLE Reminder(reminder_id INT(2), reminder_name VARCHAR(20), reminder_descr VARCHAR(20), reminder_type VARCHAR(20), reminder_creation_date DATE, reminder_creator VARCHAR(20));
CREATE TABLE NoteCategory(notecategory_id INT(2), note_id INT(2), category_id INT(2));
