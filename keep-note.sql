...
CREATE TABLE Category(category_id INT(3) primary key, category_name VARCHAR(20) not null, category_descr VARCHAR(20), category_creation_date DATETIME, category_creator VARCHAR(20) not null);
CREATE TABLE Reminder(reminder_id INT(3) primary key, reminder_name VARCHAR(20) not null, reminder_descr VARCHAR(20), reminder_type VARCHAR(20), reminder_creation_date DATETIME, reminder_creator VARCHAR(20));
