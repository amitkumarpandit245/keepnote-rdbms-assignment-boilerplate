...
CREATE TABLE NoteCategory(notecategory_id INT(3), note_id INT(3), category_id INT(3) not null ,CONSTRAINT NoteCategory_notecategory_id PRIMARY KEY(notecategory_id));
